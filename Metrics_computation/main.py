...
def ComputeMetrics2(filename, save_folder, n_neighbors):
    # n_neighbors = param['n_neighbors']
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Compute Intrinsic metrics of a PointCloud.')
    ...
    parser.add_argument('n_neighbors', metavar='n_neighbors', type=int,
                        help='The number of neighbors to consider in the computation of the metrics')
    ...
    # q = {'filename': filename, 'output_folder': save_folder, 'n_neighbors': n_neighbors}
    ComputeMetrics2(filename, save_folder, n_neighbors)
