...
Ray::Ray(const octomap::OcTreeKey& _origin, const octomap::OcTreeKey& _end, octomap::KeyRay *_ray_set,
         octomap::KeyRay::iterator _start, octomap::KeyRay::iterator _stop, const octomap::OcTreeKey& _end_unknown,
