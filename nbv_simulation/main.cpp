...
class NBV_Planner
{
  public:
    ...
    string out_status()
    {
        ...
        switch(status)
        {
            case Over: status_string = "Over"; break;
            case WaitData: status_string = "WaitData"; break;
            case WaitViewSpace: status_string = "WaitViewSpace"; break;
            case WaitInformation: status_string = "WaitInformation"; break;
            case WaitMoving: status_string = "WaitMoving"; break;
        }
                              ...
                              int iterations)
{
    ...
    { // Search by
        ...
        if(iterations == 0)
            ...
            (*now_views_infromation)->update(share_data, now_view_space, iterations);
        ...
        for(int i = 0; i < now_view_space->views.size(); i++)
        {
            if(share_data->method_of_IG == OursIG)
                ...
                now_view_space->views[i].final_utility =
                  ...
                  0.3 * (share_data->robot_cost_negtive == true ? -1 : 1) * now_view_space->views[i].robot_cost /
